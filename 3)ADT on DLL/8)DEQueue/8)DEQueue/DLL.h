...
public:
	...
	*/
	...
	T get_head() const;
	/*
		Description: returns the element located at the head of the DLL
		Throws: exception if DLL is empty
		Best Case = Worst Case = Average Case = O(1)
	*/

	T get_tail() const;
	/*
		Description: returns the element located at the tail of the DLL
		Throws: exception if DLL is empty
		Best Case = Worst Case = Average Case = O(1)
	*/
